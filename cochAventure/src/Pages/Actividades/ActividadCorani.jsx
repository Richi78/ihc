      ...
      <div className="bg-background p-6">
        ...
        <div className="act">
          <div className="actividad-box">
            <div className="actividad-corani-uno actividad-card"></div>
            <div>
              <h2 className="act2">Visita a la represa de Corani</h2>
              <p className="act3">
                La represa de Corani tiene una estructura de estilo colonial, y
                se caracteriza por su construcción de piedra y su diseño
              ...
              <p className="mt-1">
                <strong>Hora inicio:</strong> 10:00
              </p>
              <p className="mt-1">
        ...
        <div className="act">
          <div className="actividad-box act-uwu">
            <div className="actividad-corani-dos actividad-card"></div>
            <div>
              <h2 className="act2">Paseo en lancha</h2>  
              <p className="act3"> 
...
export default ActividadCorani;
