...
const ActividadPairumani = () => {
  return (
    <div className='page'>
        <MigasDePan />
    <div className="bg-background p-6">
        <div className="titulo-itinerario">
            <h1 className="text-2xl font-bold subrayado">ITINERARIO - PAIRUMANI</h1>
        </div>

        <div className="act">
            <div className="actividad-box">
                <div className="actividad-pairumani-uno actividad-card"></div>
                <div>
                    <h2 className="act2">Visita a la hacienda Pairumani</h2>
                    <p className="act3">La hacienda Pairumani tiene una estructura de estilo colonial, y se
                        ...
                        significativo. </p>
                    <p className="mt-2"><strong>Duración:</strong> 2 horas</p>
                    <p className="mt-1"><strong>Hora inicio:</strong> 08:00</p>
        ...
        <div className="act">
            <div className="actividad-box act-uwu" >
                <div className="actividad-pairumani-dos actividad-card"></div>
                <div>
                    <h2 className="act2">Visita al Parque Ecoturistico Pairumani</h2>
                    <p className="act3">El Parque Ecoturistico Pairumani ofrece una experiencia
                        auténtica,
        ...
        <div className="act">
            <div className="actividad-box">
                <div className="actividad-pairumani-tres actividad-card"></div>
                <div>
                    <h2 className="act2">Visita al ganado</h2>
                    <p className="act3">La ganaderia de Pairumani de estilo neoclásico y
                        construido a fines
                        del siglo XX, fue edificada por el párroco Ángel de
                    ...
                    <p className="mt-1"><strong>Hora fin:</strong> 13:00</p>
                </div>
            </div>
        </div>
        <div className="act">
            <div className="actividad-box act-uwu" >
                <div className="actividad-pairumani-cuatro actividad-card"></div>
                <div>
                    <h2 className="act2">Fogata en el campamento</h2>
                    <p className="act3">Las fogatas seguras del campamento ofrecen una
                        experiencia
                        auténtica,
                        donde los visitantes pueden sumergirse en la vida cotidiana de la
                        comunidad local. Los vendedores locales suelen ofrecer productos frescos y tradicionales, lo que permite
                        ...
                        experimentar la gastronomía y los productos típicos de la región.</p>
                    <p className="mt-2"><strong>Duración:</strong> 1 hora</p>
                    <p className="mt-1"><strong>Hora inicio:</strong> 19:00</p>
                    <p className="mt-1"><strong>Hora fin:</strong> 21:00</p>
                </div>
            </div>
        </div>
    </div>
...
export default ActividadPairumani