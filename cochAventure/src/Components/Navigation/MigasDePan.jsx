...
const MigasDePan = () => {
  ...
  const routeLabels = {
    ...
    'actividadcorani': 'Actividades de Corani',
    'rutaincallajta': 'Ruta Incallajta',
    'actividadincallajta': 'Actividades de Incallajta',
    'rutapairumani': 'Ruta Pairumani',
    'actividadpairumani': 'Actividades de Pairumani',
    'rutatarata': 'Ruta Tarata',
    'actividadtarata': 'Actividades de Tarata',
    'rutavillatunari': 'Ruta Villa Tunari',
    'actividadvillatunari': 'Actividades de Villa Tunari',
    'corani': 'Corani',
